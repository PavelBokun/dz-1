...
// let [filter, setFilter] = useState(Array<AffairType>);    /////// тут есть вопросы
...
export const filterAffairs = (
  ...
  if (filter === "high") {
    return affairs.filter((el) => el.priority === "high");     ///////////// фильтруем каждый affairs
  }
  if (filter === "low") {
...
function HW2() {
  ...
  setAffairs(updatedAffairs);
    ...
    // need to fix any    указал !!!!!!!!!            ////////////   тут нужно дописать
    // need to fix
  };
